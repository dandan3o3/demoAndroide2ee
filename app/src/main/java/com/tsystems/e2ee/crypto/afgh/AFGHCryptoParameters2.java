...
public class AFGHCryptoParameters2 {
    ...
    public AFGHCryptoParameters2(@Nullable PairingParameters curveParams) {
        if (curveParams == null) {
    ...
    public AFGHCryptoParameters2(@Nullable String cryptoParametersInitalString) {
    ...
    private void initialPairing() {
        ...
        e = new TypeAPairing(random, curveParams);
