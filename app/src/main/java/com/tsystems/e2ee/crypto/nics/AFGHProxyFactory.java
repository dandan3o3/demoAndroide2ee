package com.tsystems.e2ee.crypto.nics;
...
public class AFGHProxyFactory {

    public static Element generateSecretKey(AFGHCryptoParameters global) {
...
//    }
    public static Element generatePublicKey(Element sk, AFGHCryptoParameters global) {
    ...
    public static byte[] generatePublicKey(byte[] sk_bytes, AFGHCryptoParameters global) {
    ...
    public static byte[] generateReEncryptionKey(byte[] pk_bytes, byte[] sk_bytes, AFGHCryptoParameters global) {
        return generateReEncryptionKey(
                bytesToElement(pk_bytes, global.getG1()),
                bytesToElement(sk_bytes, global.getZq())).toBytes();
    }

    public static byte[] firstLevelEncryption(byte[] message, byte[] pk_a, AFGHCryptoParameters global) {
    ...
    public static Tuple firstLevelEncryption(Element m, Element pk_a, AFGHCryptoParameters global) {
    ...
    public static byte[] secondLevelEncryption(byte[] message, byte[] pk_a, AFGHCryptoParameters global) {
...
//        System.out.println("M : " + Arrays.toString(m.toBytes()));
    ...
    public static Tuple secondLevelEncryption(Element m, Element pk_a, AFGHCryptoParameters global) {
    ...
    public static Tuple secondLevelEncryption(Element m, ElementPowPreProcessing pk_a_PPP, AFGHCryptoParameters global) {
    ...
    public static Tuple reEncryption(Tuple c, Element rk, AFGHCryptoParameters global) {
    ...
    public static byte[] reEncryption(byte[] c, byte[] rk, AFGHCryptoParameters global) {
    ...
    public static Element firstLevelDecryption(Tuple c, Element sk, AFGHCryptoParameters global) {
        // c1, c2 \in G2
    ...
    public static Element firstLevelDecryptionPreProcessing(Tuple c, Element sk_inverse, AFGHCryptoParameters global) {
        // c1, c2 \in G2
        Element alpha = c.get(1);
        Element beta = c.get(2);
    ...
    public static byte[] firstLevelDecryption(byte[] b, byte[] sk, AFGHCryptoParameters global) {
...
//        System.out.println(Arrays.toString(key.invert().toBytes()));
    ...
    public static byte[] secondLevelDecryption(byte[] b, byte[] sk, AFGHCryptoParameters global) {
        // c1 \in G1, c2 \in G2
        Field G1 = global.getG1();
        Field G2 = global.getG2();
    ...
    public static Element secondLevelDecryption(Tuple c, Element sk, AFGHCryptoParameters global) {
    ...
    public static Element decryption(Tuple c, Element sk, AFGHCryptoParameters global) {
        Field G2 = global.getG2();
